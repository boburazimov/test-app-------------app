...
class UnitResourceIT {
    ...
    public static Unit createEntity(EntityManager em) {
        Unit unit = new Unit().name(DEFAULT_NAME).description(DEFAULT_DESCRIPTION);
        return unit;
    }
    ...
    public static Unit createUpdatedEntity(EntityManager em) {
        Unit unit = new Unit().name(UPDATED_NAME).description(UPDATED_DESCRIPTION);
        return unit;
    }
    ...
    void putNewUnit() throws Exception {
        ...
        updatedUnit.name(UPDATED_NAME).description(UPDATED_DESCRIPTION);
