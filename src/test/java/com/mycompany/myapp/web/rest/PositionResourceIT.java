...
class PositionResourceIT {
    ...
    public static Position createEntity(EntityManager em) {
        Position position = new Position().name(DEFAULT_NAME).info(DEFAULT_INFO);
        return position;
    }
    ...
    public static Position createUpdatedEntity(EntityManager em) {
        Position position = new Position().name(UPDATED_NAME).info(UPDATED_INFO);
        return position;
    }
    ...
    void createPosition() throws Exception {
        ...
        assertThat(testPosition.getInfo()).isEqualTo(DEFAULT_INFO);
    }
    ...
    void putNewPosition() throws Exception {
        ...
        updatedPosition.name(UPDATED_NAME).info(UPDATED_INFO);
        ...
        assertThat(testPosition.getInfo()).isEqualTo(UPDATED_INFO);
    }
    ...
    void partialUpdatePositionWithPatch() throws Exception {
        ...
        partialUpdatedPosition.info(UPDATED_INFO);
    ...
    void fullUpdatePositionWithPatch() throws Exception {
        ...
        partialUpdatedPosition.name(UPDATED_NAME).info(UPDATED_INFO);
