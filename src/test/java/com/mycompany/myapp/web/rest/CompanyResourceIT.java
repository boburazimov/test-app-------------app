...
class CompanyResourceIT {
    ...
    public static Company createEntity(EntityManager em) {
        Company company = new Company().name(DEFAULT_NAME).info(DEFAULT_INFO);
        return company;
    }
    ...
    public static Company createUpdatedEntity(EntityManager em) {
        Company company = new Company().name(UPDATED_NAME).info(UPDATED_INFO);
        return company;
    }
    ...
    void putNewCompany() throws Exception {
        ...
        updatedCompany.name(UPDATED_NAME).info(UPDATED_INFO);
    ...
    void partialUpdateCompanyWithPatch() throws Exception {
        ...
        partialUpdatedCompany.info(UPDATED_INFO);
    ...
    void fullUpdateCompanyWithPatch() throws Exception {
        ...
        partialUpdatedCompany.name(UPDATED_NAME).info(UPDATED_INFO);
