...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './unit.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_UNIT_LIST actions', async () => {
    ...
    it('dispatches FETCH_UNIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_UNIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_UNIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_UNIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_UNIT actions', async () => {
      const expectedActions = [
        {
