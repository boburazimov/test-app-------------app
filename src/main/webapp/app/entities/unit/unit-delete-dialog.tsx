...
export const UnitDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="testApp.unit.delete.question">Are you sure you want to delete this Unit?</ModalBody>
      <ModalFooter>
