...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './partner.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PARTNER_LIST actions', async () => {
    ...
    it('dispatches FETCH_PARTNER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PARTNER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PARTNER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PARTNER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PARTNER actions', async () => {
      const expectedActions = [
        {
