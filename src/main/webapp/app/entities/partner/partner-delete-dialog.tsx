...
export const PartnerDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="testApp.partner.delete.question">Are you sure you want to delete this Partner?</ModalBody>
      <ModalFooter>
