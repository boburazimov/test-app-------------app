...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './barcode.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BARCODE_LIST actions', async () => {
    ...
    it('dispatches FETCH_BARCODE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BARCODE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BARCODE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BARCODE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BARCODE actions', async () => {
      const expectedActions = [
        {
