...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './social.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SOCIAL_LIST actions', async () => {
    ...
    it('dispatches FETCH_SOCIAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SOCIAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SOCIAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SOCIAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SOCIAL actions', async () => {
      const expectedActions = [
        {
