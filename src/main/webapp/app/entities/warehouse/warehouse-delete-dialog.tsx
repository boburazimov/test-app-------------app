...
export const WarehouseDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="testApp.warehouse.delete.question">Are you sure you want to delete this Warehouse?</ModalBody>
      <ModalFooter>
