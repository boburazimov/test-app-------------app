...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './currency.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CURRENCY_LIST actions', async () => {
    ...
    it('dispatches FETCH_CURRENCY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CURRENCY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CURRENCY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CURRENCY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CURRENCY actions', async () => {
      const expectedActions = [
        {
