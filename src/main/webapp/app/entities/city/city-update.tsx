  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="testApp.city.home.createOrEditLabel" data-cy="CityCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              />
              <ValidatedField id="city-region" name="region" data-cy="region" label="Region" type="select">
                <option value="" key="0" />
                {regions
