...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRICETYPE_LIST actions', async () => {
    ...
    it('dispatches FETCH_PRICETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PRICETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PRICETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PRICETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PRICETYPE actions', async () => {
      const expectedActions = [
        {
