...
export const DistrictDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="testApp.district.delete.question">Are you sure you want to delete this District?</ModalBody>
      <ModalFooter>
